...
public class ArticleController extends Controller {
    ...
    private void doWrite() {
        ...
        Article article = new Article(id, regDate, updateDate, loginedMember.getId(), loginedMember.getName(), title, body);
    ...
    public void makeTestData() {
        ...
        articleService.add(new Article(1, "2023-12-12 12:12:12", "2023-12-12 12:12:12", 1, "test" + 1, "제목123", "내용1"));
        articleService.add(new Article(2, Util.getNow(), Util.getNow(), 2, "test" + 2, "제목72", "내용2"));
        articleService.add(new Article(3, Util.getNow(), Util.getNow(), 1, "test" + 3, "제목1233", "내용3"));
    }
}
